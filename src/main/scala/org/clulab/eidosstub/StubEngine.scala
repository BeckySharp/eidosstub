...
class StubEngine (val config: Config = ConfigFactory.load("stub")) extends Configured {
  ...
  object LoadableAttributes {
    val   masterRulesPath: String = getPath(  "masterRulesPath", "/org/clulab/stub/grammars/master.yml")
    val      taxonomyPath: String = getPath(     "taxonomyPath", "/org/clulab/stub/grammars/taxonomy.yml")
...
object MusicaEngine {
  ...
  val PREFIX: String = "EidosStubEngine"
